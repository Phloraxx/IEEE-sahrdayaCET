...
const description = "Privacy policy describing how personal data is collected, used, shared, protected and retained on the IEEE Sahrdaya platform.";
...
const sections = [
  ...
  {
    heading: "Your Rights",
    paragraphs: ["You may access, rectify, and update your personal data directly through the functionalities provided on the Platform."],
  },
  {
    heading: "Consent",
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: ["Insert Name of the Office:", "Designation:", "Insert Name and Address of the Company:"],
  },
  {
    heading: "Contact us",
    paragraphs: ["Phone: Time: Monday - Friday(9:00 - 18:00)"],
  },
];

export default function PrivacyPolicyPage() {
  return <PolicyPage title={title} path={path} sections={sections} />;
}
