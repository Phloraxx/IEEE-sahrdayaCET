...
const description = "Terms and conditions governing access to and use of the IEEE Sahrdaya platform.";
...
const intro = [
  ...
  "This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://ieeesahrdaya.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').",
  "The Platform is owned by Sourav P Bijoy, a company incorporated under the Companies Act, 1956 with its registered office at Panchajanyam Choolissery, Avanoor Thrissur, India, 680541 India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').",
...
const items = [
  ...
  "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Thrissur and Kerala.",
  "All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website.",
];

export default function TermsAndConditionsPage() {
  return <PolicyPage title={title} path={path} intro={intro} sections={[{ heading: "Terms of Use", items }]} />;
}
