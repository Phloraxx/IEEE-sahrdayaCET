...
- one continuous upcoming-to-past programme canvas;
- a compact `Past programme` archive handoff rather than a second oversized section introduction;
- visibly labelled search/society controls for the archive, without lifecycle tabs that duplicate the upcoming schedule;
