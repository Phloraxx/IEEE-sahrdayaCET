...
- current production `/`, `/events`, `/societies`, `/blog`, `/full-execom`, `/healthz`, and `/api/health` returned 200 with a browser-like request profile; public `/_/` returned 404 and Google remained the configured OAuth provider;
