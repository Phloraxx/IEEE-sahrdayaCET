...
if [[ "$REQUIRE_MAIL_LIVE" == "1" ]]; then
  ...
  check_eq "Gmail SMTP host is configured" "$smtp_host" "smtp.gmail.com"
  check_eq "Gmail SMTP port is 587" "$smtp_port" "587"
  check_eq "Gmail SMTP uses STARTTLS mode" "${smtp_tls:-false}" "false"
